class Lotion {
    ...
    Lotion(String brand,String type,String fragrance,String color,double quantity,double price,
           String skinType,boolean herbal,boolean medicated,String manufacturer,String country,
