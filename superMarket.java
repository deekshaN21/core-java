class superMarket{
   public static void main(String[] args){
	   ...
	   String Groceries[]={"Rice","Wheat","Sugar","Salt","Toor Dal","Moong Dal","Chana Dal","Urad Dal","Cooking Oil","Ghee","Milk","Curd","Butter","Bread","Eggs","Tea Powder","Coffee Powder","Turmeric Powder","Chilli Powder","Coriander Powder","Jeera","Mustard Seeds","Atta","Maida","Rava"};
	   ...
	   String perfumes[]={"Fogg","Engage","Park Avenue","Denver","Wild Stone","Skinn","Bella Vita","Axe","Layer’r Shot","Beardo","Ustraa","Yardley","Nivea","The Man Company","Armaf","Ajmal","Lattafa","Rasasi","Calvin Klein","Davidoff","Versace","Dior","Chanel","Gucci","Burberry"};
	   String meat[]={"Chicken","Mutton","Beef","Pork","Fish","Prawns","Shrimp","Crab","Lobster","Squid","Octopus","Clams","Mussels","Oysters","Salmon","Tuna","Sardine","Mackerel","Anchovy","Pomfret","Rohu","Catla","Tilapia","Turkey","Duck"};
	   String babycare[]={"Diapers","Baby Wipes","Baby Lotion","Baby Oil","Baby Shampoo","Baby Soap","Baby Powder","Baby Cream","Baby Powdered Soap","Baby Toothbrush","Baby Toothpaste","Baby Blanket","Baby Clothes","Baby Bottles","Baby Feeding Spoon","Baby Food","Pacifier","Teething Ring","Baby Bath Tub","Baby Towels","Baby Mittens","Baby Caps","Baby Socks","Baby Stroller","Baby Carrier"};
	   String spices[]={"Turmeric","Cumin","Coriander","Mustard Seeds","Fennel Seeds","Fenugreek Seeds","Cloves","Cardamom","Black Pepper","Cinnamon","Nutmeg","Mace","Chili Powder","Ginger Powder","Garlic Powder","Asafoetida","Bay Leaf","Star Anise","Curry Leaves","Carom Seeds","Saffron","Allspice","Paprika","Sumac","Dried Mint"};
	   String stationeries[]={"Pen","Pencil","Eraser","Sharpener","Notebook","Diary","Marker","Highlighter","Crayons","Color Pencils","Sketch Pen","Ruler","Geometry Box","Glue Stick","Stapler","Staples","Paper Clips","Scissors","Drawing Book","File Folder","Sticky Notes","Board Marker","Whiteboard","Correction Pen","Envelope"};
	   String souces[]={"Ketchup","Soy Sauce","Tomato Sauce","Chili Sauce","Sriracha","Barbecue Sauce","Mustard Sauce","Hot Sauce","Mayonnaise","Tartar Sauce","Pesto Sauce","Alfredo Sauce","Hollandaise Sauce","Sweet and Sour Sauce","Teriyaki Sauce","Worcestershire Sauce","Buffalo Sauce","Garlic Sauce","Cheese Sauce","Chili Garlic Sauce","Taco Sauce","Ranch Sauce","Curry Sauce","Brown Sauce","Vinegar Sauce"};
	   String frozenFood[]={"Frozen Peas","Frozen Corn","Frozen Mixed Vegetables","Frozen Spinach","Frozen Broccoli","Frozen Carrots","Frozen French Fries","Frozen Paratha","Frozen Naan","Frozen Samosa","Frozen Spring Roll","Frozen Pizza","Frozen Chicken Nuggets","Frozen Fish Fingers","Frozen Shrimp","Frozen Meatballs","Frozen Paneer","Frozen Dhokla","Frozen Idli","Frozen Dosa","Frozen Momos","Frozen Waffles","Frozen Berries","Frozen Ice Cream","Frozen Dessert"};
